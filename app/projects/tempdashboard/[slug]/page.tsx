...
import DashboardCard from '@/components/ui/Dashboard/Dashboard';
import { useRouter } from 'next/navigation';
/* SWPPPY THE SWPPP AI Assistant Placeholder Page */
      ...
      <div className="flex justify-between items-center w-full px-[15%]">
        <div className="flex-grow">
          <DashboardCard
            ...
            weatherDataThree={weatherDataThree}
            weatherDataFour={weatherDataFour}
            weatherDataFive={weatherDataFive}
            propertyId={projectIdNumber}
          />
        </div>
      </div>
      <div className="flex-shrink-0">
          <button type="button" id="btn" onClick={routeToEditPage}>
            Edit Project
          </button>
        </div>
    </>
